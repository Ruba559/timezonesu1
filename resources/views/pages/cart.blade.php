@extends('layouts.master', ['title' => 'Time Zone | Shopping Cart'])
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                            type="button" role="tab" aria-controls="home" aria-selected="true"><span
                                class="fa fa-shopping-cart mx-1"></span>Cart</button>
                    </li>
                    @auth()
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                                type="button" role="tab" aria-controls="profile" aria-selected="false"><span
                                    class="fa fa-file mx-1"></span> Orders</button>
                        </li>
                    @endauth()
                </ul>
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active home container-fluid" id="home" role="tabpanel"
                            ...
                            <div class="row d-flex justify-content-start my-4">
                                <div class="col-md-12 ">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="radius-20 p-md-3 p-2 table-responsive"
                                                style="border:thin rgba(255, 255, 255, 0.2) solid">
                                                    ...
                                                    <tbody>
                                                        @foreach ($orders as $item)
                                                            <tr class="text-white70">
                                                                ...
                                                                <td><button type="button" class="btn bg-blue text-white"
                                                                        data-toggle="modal"
                                                                                    ...
                                                                                    <table class="table ">
                                                                                        ...
                                                                                        <tbody>
                                                                                            @foreach ($item->details as $item2)
                                                                                                <tr class="text-white70">
                                                                                                    <td> <img
                                                                                                            src="{{ asset('storage/' . json_decode($item2->product->images, true)[0]) }}"
                                                                                                            width="80px"
                                                                                                            hieght="80px"
                                                                                                            class="img-fluid img-thumbnail rounded-circle"
                                                                                                            alt="Sheep">
                                                                                                    </td>
                                                                                                    <td>{{ $item2->product->name }}
                                                                                                    </td>
                                                                                                    <td>{{ $item2->price }}
                                                                                                    </td>
                                                                                                    <td>{{ $item2->quantity }}
                                                                                                    </td>
                                                                                                    <td>{{ $item2->total_price }}
                                                                                                    </td>
                                                                                            @endforeach
