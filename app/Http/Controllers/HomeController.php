...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $womanProducts  = Product::where('status' , '1')->where('stock' , '1')->where('gender' , 1)->orderBy('created_at','DESC')->limit(4)->get();
        $manProducts  = Product::where('status' , '1')->where('stock' , '1')->where('gender' , 0)->orderBy('created_at','DESC')->limit(4)->get();
        ...
        return view('welcome' , ['brands' =>  $brands , 'newProducts' => $newProducts ,/*  'womanProducts' => $womanProducts ,
         'manProducts' => $manProducts , */ 'banners' => $banners ,'topSalesProducts' => $topSalesProducts ,'categories'=>$categories]);
    }
