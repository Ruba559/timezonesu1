...
class Product extends Model
{
    ...
    {
      return  ProductResource::collection($querry->where('category_id' ,$id)->get());
    }
    ...
    public function ScopeFeatureProducts($querry)
    {
      return ProductResource::collection($querry->where('status' , '1')->where('stock' , '1')->where('is_feature' , '1')->orderBy('created_at','DESC')->get());
    }
